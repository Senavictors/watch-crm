      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <Btn
          ...
          style={{
            ...
            fontSize: 13,
            fontWeight: 600,
            boxShadow: "0 1px 0 0 rgba(255,255,255,0.4) inset, 0 1px 2px rgba(0,0,0,0.2)",
        ...
        {models.map((m) => {
          ...
          >
            ...
            <div style={{ padding: 16, display: "grid", gap: 8 }}>
              <div style={{ color: "#F8FAFC", fontWeight: 600, fontSize: 15 }}>{m.name}</div>
              <div style={{ color: "#94A3B8", fontSize: 12 }}>{brandById.get(m.brandId) || "—"}</div>
              <div
                style={{
                  color: "#60A5FA",
                  fontSize: 11,
